...
tags: [machinelearning, sklearn, classification, knn, crossvalidation, visualization, iris]
---

Let's start with an example of classification task. We shall use kNN classifier and iris dataset.
...
<img src="/images/petal_sepal.png" width = "50%"/>
