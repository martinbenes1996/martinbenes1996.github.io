...
```python
iris.target_names # names of target
```
...
Our task will be to determine the species for a sample based on the information about its petals and sepals.
...
![png](/img/knn_iris_files/knn_iris_11_0.png)
...
![png](/img/knn_iris_files/knn_iris_13_0.png)
...
![png](/img/knn_iris_files/knn_iris_27_0.png)
...
![png](/img/knn_iris_files/knn_iris_38_0.png)
