...
Let's go through a basic steps of a classification workflow on species of plants in popular dataset *iris*. For implementation we shall use Python and a library *scikit-learn* (`sklearn`). To score the accuracy we will see a holdout and a cross-validation.
...
![png](/images/knn_iris_files/knn_iris_7_0.png)
...
![png](/images/knn_iris_files/knn_iris_9_0.png)
...
![png](/images/knn_iris_files/knn_iris_23_0.png)
...
### Accuracy dependence on hyperparameter
...
![png](/images/knn_iris_files/knn_iris_34_0.png)
